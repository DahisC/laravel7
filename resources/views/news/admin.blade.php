    ...
    <div class="container news-admin">
        <form action="{{ isset($news) ? "/news/update/$news->id" : '/news/create' }}" method="POST">
            ...
            <div>
                ...
                <input id="date" type="date" placeholder="日期 date" name="date" value="{{ $news->date ?? '2020-05-05' }}" />
            </div>
            <div>
            ...
            <div>
                ...
                <textarea id="content" type="text" placeholder="內容 Content" name="content" rows="10">{{ $news->content ?? 'DJ、音楽プロデューサー、DJ Okawariとは?
